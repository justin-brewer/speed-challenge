...
###############################################################
#37
label_list = ['train_labels_20400_one_hot_double.npy',
                'train_labels_20400_one_hot_4xprec.npy',
                'train_labels_20400_one_hot_8xprec.npy',
                'train_labels_20400_one_hot_16xprec.npy',
                'train_labels_20400_one_hot_32xprec.npy',
                'train_labels_20400.npy']
#37
one_hot_labels = np.load('data/' + label_list[2])
#37
labels = np.float32(np.load('data/' + label_list[5]))
#37
data_list = ['train_20400x2400_fzm_5avg.npy',
                'train_20400x2400_fzm_4avg.npy',
                'train_20400x2400_fzm_2avg.npy',
                'train_20400x2400_fzm_3avg.npy',
                'train_20400x2400_flow_zoom.npy',]
#37
...
test_dataset = data[train_i:,...]
test_labels = labels[train_i:]
test_labels_a = one_hot_labels[train_i:,...]
#########################
def mse(p, y):
...
with graph.as_default():
    ...
    tf_employment = tf.placeholder(
        tf.float32, shape=(None, d_size), name='emp_data')
  ...
  # Model.
    def model(data, keep_prob, batch_size):
        ...
        logits = tf.matmul(tf.nn.softmax(lc4), l_filter) - 1
    ...
    test_prediction = model(
        tf_test_dataset, keep_prob, tf_test_dataset.shape[0])
